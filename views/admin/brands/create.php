                ...
                <form action="<?= BASE_URL ?>/admin/brands/create" method="POST" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="brand_name" name="brand_name" value="<?= isset($_POST['brand_name']) ? htmlspecialchars($_POST['brand_name']) : '' ?>" class="w-full px-4 py-2 border <?= isset($errors['brand_name']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập tên thương hiệu">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="w-full px-4 py-2 border <?= isset($errors['description']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập mô tả về thương hiệu"><?= isset($_POST['description']) ? htmlspecialchars($_POST['description']) : '' ?></textarea>
