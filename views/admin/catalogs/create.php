                ...
                <form action="<?= BASE_URL ?>/admin/catalogs/create" method="POST" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="catalog_name" name="catalog_name" value="<?= isset($_POST['catalog_name']) ? htmlspecialchars($_POST['catalog_name']) : '' ?>" class="w-full px-4 py-2 border <?= isset($errors['catalog_name']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập tên danh mục">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="w-full px-4 py-2 border <?= isset($errors['description']) ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập mô tả về danh mục"><?= isset($_POST['description']) ? htmlspecialchars($_POST['description']) : '' ?></textarea>
                        ...
                        <!-- Image Field -->
                        <div>
                            <label for="catalog_image" class="block text-gray-700 font-semibold mb-2">Ảnh Danh Mục</label>

                            <div class="flex items-center justify-center w-full">
                                <label for="catalog_image" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-100">
