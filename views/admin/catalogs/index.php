        ...
        <div class="flex-1 p-8 overflow-auto">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <table class="min-w-full bg-white">
                    <thead>
                        <tr>
                            <th class="py-2 px-4 border-b text-left text-gray-600" style="width: 15%;">Tên danh mục</th>
                            <th class="py-2 px-4 border-b text-left text-gray-600" style="width: 60%;">Mô tả</th>
                            <th class="py-2 px-4 border-b text-left text-gray-600" style="width: 10%;">Hình ảnh</th>
