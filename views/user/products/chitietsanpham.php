        ...
        <div class="bg-white rounded-md px-3 py-4 shadow-sm">
          ...
          <?php } else { ?>
            <div class="mt-3">
              ...
              <p class="inline-block w-1/3 text-sm mt-2 p-4">Năm xuất bản: <span class="font-bold"><?php echo !empty($product['publish_year']) ? $product['publish_year'] : 'Chưa cập nhật' ?></span></p>
            </div>
          <?php } ?>
