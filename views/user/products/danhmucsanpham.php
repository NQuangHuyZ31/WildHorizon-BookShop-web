  ...
  <div class="flex flex-col px-2 lg:px-0 lg:flex-row">
    ...
    <div class="whr-product-main flex-1">
      <div class="mt-3 ps-4 bg-white py-3 rounded-md flex items-center">
        <p class="text-[14px] lg:text-[16px] uppercase font-bold text-black"><?php echo isset($keyword) ? $keyword : $slug ?></p>
        <p class="text-blue-500 text-[12px] lg:text-[14px] ms-1">(
          <span class="product-count"><?php echo count($products) ?> sản phẩm</span>)
        </p>
      </div>
      <?php if (!empty($products)) { ?>
        <div class="grid grid-cols-3 mt-2 gap-2 whr-product mb-3 lg:mb-0 lg:gap-4 lg:grid-cols-5 lg:mt-4">
