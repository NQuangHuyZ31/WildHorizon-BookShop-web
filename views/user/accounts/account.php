        ...
        <div class="w-full bg-white rounded-md shadow-md p-4 mt-3">
          ...
          <div class="w-full mt-3">
            <div class="w-full flex items-center py-3">
              <div class="profile-label text-[12px] text-gray-500 after:content-['*'] after:ml-0.5 after:text-red-500 py-1">Họ tên</div>
              <input type="text" name="username" id="username" value="<?php echo $customer['username'] ?>" class="w-2/3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-[12px] focus:ring-1" placeholder="ví dụ: Nguyễn Văn A">
            </div>
            <div class="w-full flex items-center py-3">
              <div class="profile-label text-[12px] text-gray-500 after:content-['*'] after:ml-0.5 after:text-red-500 py-1">Số điện thoại</div>
              <input type="text" name="phone" id="phone" value="<?php echo $customer['phone'] != null ? $customer['phone'] : '' ?>" class="w-2/3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-[12px] focus:ring-1" placeholder="ví dụ: 0366.465.273">
            </div>
            <div class="w-full flex items-center py-3">
              <div class="profile-label text-[12px] text-gray-500 after:content-['*'] after:ml-0.5 after:text-red-500 py-1">Giới tính</div>
              <div class="flex">
                ...
                <label class="text-gray-500 ms-3 text-[12px]">Nam</label>
              </div>
              <div class="flex ms-4">
                ...
                <label class="text-gray-500 ms-3 text-[12px]">Nữ</label>
              </div>
            </div>
            <div class="w-full flex items-center py-3">
              <div class="profile-label text-[12px] text-gray-500 after:content-['*'] after:ml-0.5 after:text-red-500 py-1">Ngày sinh</div>
              <div class="w-2/3 flex justify-around items-center text-center">
                <input
                  ...
                  class="w-1/3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-[12px] focus:ring-1 mr-2"
                  placeholder="08"
                ...
                <input
                  ...
                  class="w-1/3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md sm:text-[12px] focus:ring-1"
                  placeholder="2003"
                  <?php echo $customer['birthday'] != null ? 'readonly' : '' ?>>
              </div>
            </div>
          ...
          <div class="w-full text-center mt-2 p-2">
            <button type="button" id="btn-update-customer" class="py-2 px-14 tracking-wide bg-red-700 text-white font-bold text-[12px] rounded-md">Lưu thay đổi</button>
          </div>
        </div>
      </div>
    </div>
