  ...
  <div class="w-full mt-3 mb-3">
    <div class="flex flex-col lg:mb-0 lg:flex-row w-full">
      ...
      <div class="flex-1 px-1 lg:ms-3">
        <div class="w-full bg-white rounded-md shadow-sm lg:shadow-md pb-4 px-4">
          <div class="p-4">
            <p class="text-[14px] lg:text-lg font-bold text-slate-500">Nhận xét của tôi</p>
            <div class="mt-3 border border-gray-200 rounded-md p-3">
              <p class="text-[12px] lg:text-[14px] text-gray-400 font-semibold">Đánh giá đơn hàng</p>
                ...
                <?php foreach ($order_reviews as $review) { ?>
                  <div class="border border-gray-200 rounded-md p-2 mt-3">
                    <div class="mb-2">
                      ...
                      <div class="flex items-center text-[12px] lg:text-[14px] text-gray-400 py-2">
                        <p>Rating: </p>
                      ...
                      <div class="text-[12px] lg:text-[14px] flex items-center">
                        <p>Đánh giá:</p>
              ...
              <?php } else { ?>
                <div class="mt-3 flex text-[13px] items-center ps-3">
                  ...
                  <p class="text-red-700 font-semibold lg:text-sm text-[11px]">Bạn chưa có đánh giá nào.</p>
                </div>
              <?php } ?>
            </div>
            <?php if ($feedbacks != null) { ?>
              <div class="mt-3 border border-gray-200 rounded-md p-3">
                <p class="text-[12px] lg:text-[14px] text-gray-400 font-semibold">Các feedback đã được trả lời</p>
                <?php foreach ($feedbacks as $feedback) { ?>
                  <div class="border border-gray-200 rounded-md p-2 mt-3">
                    <p class="text-[12px] lg:text-[14px] text-orange-500"><?php echo date('d-m-Y', strtotime($feedback['created_at'])) ?></p>
...
<dialog id="review_product_modal" class="modal">
  <div class="modal-box ">
    ...
    <div class="review-content w-full">
      <div class="review-product-content text-[12px] lg:text-[14px] text-gray-400 mt-2">
