      ...
      <div class="w-full px-1 lg:w-[75%] lg:ms-3">
        ...
        <?php } else if ($order['payment_method'] == 'VNPAY' && $order['is_payment'] == 1) { ?>
          <div class="mx-auto px-4 py-1 mb-3 bg-white shadow-lg rounded-lg w-full flex items-center">
            ...
            <p class="text-[15px]">Đơn hàng này đã được thanh toán.</p>
          </div>
        <?php } ?>
        <div class="mx-auto p-6 bg-white shadow-lg rounded-2xl w-full">
          <p class="text-xl text-gray-500 font-semibold">Chi tiết đơn hàng</p>
          <?php if ($order_review != null) { ?>
            <div class="flex items-center pt-1 text-[13px] text-gray-500">
          ...
          <div class="flex items-center justify-between text-[14px]">
            ...
            <p class="text-[12px] text-gray-400">Ngày đặt hàng: <?php echo date('d/m/Y', strtotime($order['order_date'])) ?></p>
          </div>

          <div class="relative mt-6 mb-8">
            <!-- Line background -->
            <div class="absolute bg-gray-200 h-[2px] top-[30%] left-[3%]" style="width: calc(100% - 50px);"></div>
            ...
            <div class="flex justify-between gap-2 lg:gap-0 w-full">
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-xs mt-2 <?php echo in_array($order['status'], ['Chờ xác nhận', 'Chuẩn bị hàng', 'Đang giao hàng', 'Đã giao hàng']) ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Chờ xác nhận</p>
              </div>
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-xs mt-2 <?php echo in_array($order['status'], ['Chuẩn bị hàng', 'Đang giao hàng', 'Đã giao hàng']) ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Chuẩn bị hàng</p>
              </div>
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-xs mt-2 <?php echo in_array($order['status'], ['Đang giao hàng', 'Đã giao hàng']) ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Đang giao hàng</p>
              </div>
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-xs mt-2 <?php echo in_array($order['status'], ['Đã giao hàng'])  ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Đã giao hàng</p>
              </div>
            </div>
          </div>
          <!-- Thông tin sản phẩm -->
          ...
          <div class="border border-gray-300 rounded-md p-3 mb-3">
            <div class="border-b border-gray-300">
              <p class="py-3 text-black text-xl font-semibold">Đơn hàng</p>
            ...
            <div class="flex items-center justify-between pt-3 font-semibold text-black">
              <p>Total</p>
          ...
          <div class="mt-3">
            <div class="border border-gray-300 rounded-md p-3 mb-3 text-[14px]">
              <p class="text-lg font-semibold py-2">Khách hàng</p>
            ...
            <div class="border border-gray-300 rounded-md p-3 mb-3 text-[14px]">
              <p class="text-lg font-semibold py-2">Địa chỉ giao hàng</p>
              <div class="flex items-center py-2 text-gray-600">
                <i class="fa-solid fa-user mr-3"></i>
                <p><?php echo $order_shipping_address['full_name'] ?></p>
              </div>
