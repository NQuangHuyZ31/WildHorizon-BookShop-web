    ...
    <div class="flex flex-col lg:mb-0 lg:flex-row w-full">
      ...
      <div class="w-full px-1 lg:w-[75%] lg:ms-3">
        <?php if ($order['payment_method'] == 'VNPAY' && $order['is_payment'] == 0) { ?>
          <div class="mx-auto p-2 mb-3 bg-white shadow-sm lg:shadow-lg rounded-2xl w-full flex items-center justify-between">
            <div class="flex items-center px-4 text-[12px] lg:text-[14px]">
        ...
        <?php } else if ($order['payment_method'] == 'VNPAY' && $order['is_payment'] == 1) { ?>
          <div class="mx-auto px-4 py-1 mb-3 bg-white shadow-lg rounded-lg w-full flex items-center">
            ...
            <p class="text-[13px] lg:text-[15px]">Đơn hàng này đã được thanh toán.</p>
          </div>
        <?php } ?>
        <div class="mx-auto p-6 bg-white shadow-sm lg:shadow-lg rounded-2xl w-full">
          <p class="text-[14px] lg:text-xl text-gray-500 font-semibold">Chi tiết đơn hàng</p>
          <?php if ($order_review != null) { ?>
            <div class="flex items-center pt-1 text-[11px] lg:text-[13px] text-gray-500">
          ...
          <?php } ?>
          <div class="flex items-center justify-between text-[12px] lg:text-[14px]">
            <p class=" text-orange-700 font-semibold mt-2">Mã đơn hàng: #<?php echo $order['id'] ?></p>
            <p class="text-[10px] lg:text-[12px] text-gray-400">Ngày đặt hàng: <?php echo date('d/m/Y', strtotime($order['order_date'])) ?></p>
          </div>
          ...
          <div class="relative mt-6 mb-8">
            ...
            <div class="flex justify-between gap-2 lg:gap-0 w-full">
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-[10px] lg:text-xs mt-2 <?php echo in_array($order['status'], ['Chờ xác nhận', 'Chuẩn bị hàng', 'Đang giao hàng', 'Đã giao hàng']) ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Chờ xác nhận</p>
              </div>
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-[10px] lg:text-xs mt-2 <?php echo in_array($order['status'], ['Chuẩn bị hàng', 'Đang giao hàng', 'Đã giao hàng']) ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Chuẩn bị hàng</p>
              </div>
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-[10px] lg:text-xs mt-2 <?php echo in_array($order['status'], ['Đang giao hàng', 'Đã giao hàng']) ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Đang giao hàng</p>
              </div>
              ...
              <div class="flex flex-col items-center text-center z-10">
                ...
                <p class="text-[10px] lg:text-xs mt-2 <?php echo in_array($order['status'], ['Đã giao hàng'])  ? 'text-green-600 font-medium' : 'text-gray-500' ?>">Đã giao hàng</p>
              </div>
            </div>
          </div>
          <!-- Thông tin sản phẩm -->
            ...
            <?php foreach ($order_details as $order_detail) { ?>
              <div class="border border-gray-300 rounded-md flex items-center justify-between p-3 mb-3">
                <div class="flex items-center">
                  ...
                  <div class="flex h-full flex-col text-[12px] lg:text-sm text-gray-600 leading-3">
                ...
                <div class="px-3 text-nowrap">
                  <p class="text-black font-semibold text-[14px] lg:text-sm"><?php echo Format::formatNumber($order_detail['total']) ?> đ</p>
                </div>
              </div>
            <?php } ?>
          </div>
          <div class="border border-gray-300 rounded-md p-3 mb-3">
            <div class="border-b border-gray-300">
              <p class="py-3 text-black text-[15px] lg:text-xl font-semibold">Đơn hàng</p>
              <div class="flex items-center justify-between py-3 text-[12px] lg:text-sm">
                <p>Thành tiền</p>
              ...
              <div class="flex items-center justify-between py-3 text-[12px] lg:text-sm text-sm">
                <p>Phương thức thanh toán</p>
                <p><?php echo $order['payment_method'] ?></p>
              </div>
            </div>
            <div class="flex items-center justify-between pt-3 font-semibold text-black lg:text-sm text-sm">
              <p>Total</p>
          ...
          <div class="mt-3">
            <div class="border border-gray-300 rounded-md p-3 mb-3 text-[14px]">
              <p class="text-[15px] lg:text-lg font-semibold py-2">Khách hàng</p>
              <div class="flex items-center py-2 text-gray-600 text-[12px] lg:text-sm">
            ...
            <div class="border border-gray-300 rounded-md p-3 mb-3 text-[14px]">
              <p class="text-[15px] lg:text-lg font-semibold py-2">Địa chỉ giao hàng</p>
              <div class="flex items-center py-2 text-gray-600 text-[12px] lg:text-sm">
                <i class="fa-solid fa-user mr-3"></i>
                <p><?php echo $order_shipping_address['full_name'] ?></p>
              </div>
              <div class="py-2 text-gray-600 text-[12px] lg:text-sm">
