...
<div class="w-full xl:max-w-screen-xl xl:mx-auto">
  <div class="w-full mt-3 mb-3 min-h-[550px]">
    <div class="flex flex-col xl:mb-0 xl:flex-row w-full">
      ...
      <div class="flex-1 p-1 xl:ms-3">
        <div class="customer-address-content w-full bg-white rounded-md shadow-sm xl:shadow-md pb-4 px-4">
          <?php if ($customer_address != null) { ?>
            <div class="px-4 py-3">
              <div class="flex justify-between items-center">
                <p class="text-[14px] xl:text-lg font-bold text-slate-500">Sổ địa chỉ</p>
                <div class="text-sm text-sky-500 flex items-center cursor-pointer font-semibold">
                  <i class="fa-solid fa-plus"></i>
                  <p class="ms-2 text-[12px] xl:text-sm"><a href="<?php echo BASE_URL ?>/customer/address/add">Thêm địa chỉ mới</a></p>
                </div>
              </div>
            </div>
            <?php foreach ($customer_address as $address) { ?>
              <div class="mt-2 py-3 px-4 border-b border-slate-200">
                <div class="flex justify-between items-center">
                  <div class="flex items-start flex-col text-m font-semibold text-black tracking-wide xl:flex-row xl:items-center">
                    ...
                    <div class="<?php echo $address['default_address'] == 1 ? 'block' : 'hidden' ?> mt-2 xl:mt-0 xl:ms-4 bg-blue-100 p-1 rounded-sm">
                ...
                <div class="text-[12px] xl:text-sm mt-1">
            ...
            <div class="p-4">
              ...
              <div class="mt-2">
                ...
                <div class="flex justify-end mt-3 text-center">
                  <button type="button" id="btn-save-address" class="px-11 py-2 text-[12px] xl:text-[15px] text-white bg-red-700 rounded-lg font-semibold xl:px-14">Lưu địa chỉ</button>
                </div>
              </div>
            </div>
          <?php } ?>
