    ...
    <div class="flex flex-col xl:mb-0 xl:flex-row w-full">
      ...
      <div class="flex-1 px-1 xl:ms-4">
        <div class="bg-white rounded-md shadow-sm xl:shadow-lg xl:mx-2 w-full p-4 border border-gray-100">
          <p class="text-[14px] xl:text-lg font-bold">Đổi mật khẩu</p>
          <div class="mt-3">
            <input type="hidden" name="csrf_token" value="<?php echo $csrf_token ?>">
            <div class="w-full flex items-center py-3">
              <div class="profile-label text-[11px] xl:text-[13px] text-gray-500 after:content-['*'] after:ml-0.5 after:text-red-500 py-1 mr-2">Mật khẩu hiện tại</div>
              <input
                type="password"
                name="old_password"
                id="old_password"
          ...
          <div class="flex justify-end mt-3 text-center">
            <button type="button" id="btn-changepw" class="px-11 py-2 text-[12px] xl:text-[15px] text-white bg-red-700 rounded-lg font-semibold xl:px-14">
              Lưu thay đổi
            </button>
          </div>
        </div>
