    ...
    <div class="flex flex-col lg:mb-0 lg:flex-row w-full">
      ...
      <div class="flex-1 px-1 lg:ms-4">
        <div class="bg-white rounded-md shadow-sm lg:shadow-lg lg:mx-2 w-full p-4 border border-gray-100">
          <p class="text-[14px] lg:text-lg font-bold">Xác nhận đổi mật khẩu</p>
          <div class="mt-3">
            <form action="<?php echo BASE_URL ?>/customer/changepassword/verify" method="post">
              ...
              <div class="w-full flex items-center py-3">
                ...
                <input
                  ...
                  class="w-2/3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block rounded-md text-[11px] lg:text-[13px] focus:ring-1"
                ...
                <div class="p-1">
                  <div class="flex items-center gap-3">
                    <input
                      type="text"
                      name="code_verify[]"
                      class="w-10 h-10 text-center text-[12px] lg:text-[14px] font-extrabold text-slate-900 bg-slate-100 border border-transparent hover:border-slate-200 appearance-none rounded p-2 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
                      maxlength="1" />
                    <input
                      type="text"
                      name="code_verify[]"
