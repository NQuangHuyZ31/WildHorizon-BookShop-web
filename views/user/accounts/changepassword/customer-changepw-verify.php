                ...
                <div class="p-1">
                  <div class="flex items-center gap-3">
                    <input
                      type="text"
                      name="code_verify[]"
                      class="w-10 h-10 text-center text-[14px] font-extrabold text-slate-900 bg-slate-100 border border-transparent hover:border-slate-200 appearance-none rounded p-2 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
                      maxlength="1" />
                    <input
                      type="text"
                      name="code_verify[]"
