        ...
        <div class="w-full max-w-6xl mx-auto px-4 md:px-6 py-24">
          <div class="flex justify-center">
            <div class="max-w-md mx-auto text-center bg-white px-4 sm:px-8 py-10 rounded-xl shadow">
              <header class="mb-8">
                <h1 class="text-2xl font-bold mb-1">Xác thực tài khoản của bạn</h1>
                <p class="text-[15px] text-slate-500">Vui lòng nhập 4 số được gửi về email bạn đăng ký tài khoản</p>
              </header>
