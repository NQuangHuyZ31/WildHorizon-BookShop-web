...
<body>
  <div class="register-content min-h-screen bg-cover bg-no-repeat px-3">
    <div class="container-fuild flex items-center justify-center px-3 min-h-screen mx-auto">
      <div class="bg-white whr-register w-full rounded-xl shadow-2 pb-3 pt-5">
        <div class="mb-1 text-center border-b-2 border-gray-200 shadow-sm pb-2">
          <p class="font-bold text-orange-400 text-[15px] lg:text-2xl mb-2">Đăng Ký Tài Khoản </p>
        ...
        <div class="px-9 mt-3">
          <form id="form-signup" action="<?php echo BASE_URL . '/dang-ky' ?>" method="post">
            ...
            <div class="py-1 mb-2 lg:mb-3">
              <label class="block">
                <span class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-[11px] lg:text-sm font-medium text-gray-500 ms-2">
                  Tên người dùng
                </span>
                <input type="text" name="username"
                  class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-[11px] lg:text-sm focus:ring-1"
                ...
                <div class="relative">
                  ...
                  <div class="whr-show-hidden-pw-icon flex z-50">
                    <div class="cursor-pointer flex items-center justify-center" style="width: 24px;height: 24px;" id="togglePassword">
                      <div class="whr-show-pw-icon text-[12px] lg:text-[14px]">
                        <i class="fa-regular fa-eye"></i>
                      </div>
                      <div class="whr-hidden-pw-icon text-[12px] lg:text-[14px] hidden">
            ...
            <div class="py-1 mb-2 lg:mb-3">
              <label class="block">
                ...
                <div class="relative">
                  <input type="password" id="whr-login-cfpassword" name="cfpassword" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-[11px] lg:text-sm focus:ring-1" placeholder="Nhập lại mật khẩu" />
            ...
            <div class="flex justify-start my-1 lg:pb-4">
              <label for="example-checkbox" class="inline-flex items-center space-x-2">
                ...
                <span class="text-gray-400 text-[11px] lg:text-sm">Tôi đồng ý với các điều khoản và điều kiện</span>
              </label>
            </div>
        ...
        <div class="flex justify-center mt-3">
          <span class="text-[11px] lg:text-sm text-gray-400">Bạn đã có tài khoản? <a href="<?php echo BASE_URL . '/dang-nhap' ?>" class="text-sky-500">Đăng nhập ngay</a></span>
        </div>
        <div class="flex flex-col items-center mt-3 pb-3">
          <span class="text-gray-400 text-[11px] lg:text-sm">Hoặc, đăng nhập với</span>
          <div class="flex justify-center mt-3">
            <div class="flex items-center text-[11px] lg:text-sm text-gray-500 mr-4 cursor-pointer">
            ...
            <div class="flex items-center text-[11px] lg:text-sm text-gray-500 cursor-pointer">
