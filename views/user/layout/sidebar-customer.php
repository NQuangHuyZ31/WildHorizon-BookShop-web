<div class="c-sidebar bg-white w-1/4 rounded-lg shadow-md py-3">
  ...
  <div class="mt-2">
    <div class="py-2">
      <li class="list-none border-s-6 border-red-700 flex items-center ">
        <div class="flex items-center">
          ...
          <a href="<?php echo BASE_URL ?>/customer/account">
            <p class="text-sm pt-1 mx-2 <?php echo basename($_SERVER['REQUEST_URI']) == 'account' ? 'text-red-700 font-bold' : '' ?>">Thông tin tài khoản</p>
          </a>
    ...
    <li class="list-none flex items-center ">
      <div class="flex items-center">
        ...
        <a href="<?php echo BASE_URL ?>/customer/order">
          <p class="text-sm pt-1 mx-2 hover:text-orange-400 <?php echo basename($_SERVER['REQUEST_URI']) == 'order' ? 'text-red-700' : 'text-gray-600' ?>">Đơn hàng của tôi</p>
        </a>
      </div>
    </li>
  </div>
    ...
    <li class="list-none flex items-center ">
      <div class="flex items-center">
        ...
        <a href="<?php echo BASE_URL ?>/customer/voucher">
          <p class="text-sm pt-1 mx-2 hover:text-orange-400 <?php echo basename($_SERVER['REQUEST_URI']) == 'voucher' ? 'text-red-700' : 'text-gray-600' ?>">Ví voucher</p>
        </a>
      </div>
    </li>
  </div>
    ...
    <li class="list-none flex items-center ">
      <div class="flex items-center">
        ...
        <a href="<?php echo BASE_URL ?>/customer/wishlist">
          <p class="text-sm pt-1 mx-2 hover:text-orange-400 <?php echo basename($_SERVER['REQUEST_URI']) == 'wishlist' ? 'text-red-700' : 'text-gray-600' ?>">Sản phẩm yêu thích</p>
        </a>
      </div>
    </li>
  </div>
    ...
    <li class="list-none flex items-center ">
      <div class="flex items-center">
        ...
        <a href="<?php echo BASE_URL ?>/customer/review">
          <p class="text-sm pt-1 mx-2 hover:text-orange-400 <?php echo basename($_SERVER['REQUEST_URI']) == 'review' ? 'text-red-700' : 'text-gray-600' ?>">Nhận xét của tôi</p>
        </a>
      </div>
    </li>
  </div>
