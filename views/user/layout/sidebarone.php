  ...
  <div class="w-full sticky" style="top: 16px;">
    <div class="mt-2 px-1 border-b border-gray-100">
      ...
      <ul class="ms-3 px-2 py-1 text-slate-500" style="font-size: 14px;">
        <?php foreach ($categories as $category) { ?>
          <li class="leading-5 mb-2 hover:text-orange-400 <?php echo $category['id'] == $id ? 'text-orange-400' : '' ?>">
    ...
    <div class="mt-2 px-1 border-b border-gray-100">
      ...
      <ul class="px-2 py-1 text-slate-500" style="font-size: 14px;">
        ...
        <li class="leading-5 mb-2 hover:text-orange-400">
          <a class="ps-5 price-unchecked cursor-pointer" id="price-m-2" data-id="2" data-from="150000" data-to="300000">
            150,000đ - 300,000đ
          </a>
        </li>
        <li class="leading-5 mb-2 hover:text-orange-400">
        ...
        <ul class="px-2 py-1 text-slate-500" style="font-size: 14px;">
          <?php foreach ($suppliers as $supplier) { ?>
            <li class="leading-5 mb-2  hover:text-orange-400 cursor-pointer">
              <a class="ps-5 price-unchecked" id="supplier-m-<?php echo $supplier['id'] ?>" data-id="<?php echo $supplier['id'] ?>">
      ...
      <div class="mt-2 px-1 border-b border-gray-100">
        ...
        <ul class="px-2 py-1 text-slate-500" style="font-size: 14px;">
          <?php foreach ($brands as $brand) { ?>
            <li class="leading-5 mb-2  hover:text-orange-400 cursor-pointer">
              <a class="ps-5 price-unchecked" id="brand-m-<?php echo $brand['id'] ?>" data-id="<?php echo $brand['id'] ?>">
      ...
      <div class="mt-2 px-1 border-b border-gray-100">
        ...
        <ul class="px-2 py-1 text-slate-500" style="font-size: 14px;">
          <?php foreach ($colors as $color) { ?>
            <li class="leading-5 mb-2  hover:text-orange-400 cursor-pointer">
              <a class="ps-5 price-unchecked" id="color-m-<?php echo $color['id'] ?>" data-id="<?php echo $color['id'] ?>">
