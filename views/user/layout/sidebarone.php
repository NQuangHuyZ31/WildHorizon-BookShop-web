  ...
  <div class="w-full sticky" style="top: 16px;">
    <div class="mt-2 px-1 border-b border-gray-100">
      ...
      <ul class="ms-3 px-2 py-1 text-slate-500" style="font-size: 14px;">
        <?php foreach ($categories as $category) { ?>
          <li class="leading-5 mb-2 hover:text-orange-400 <?php echo $category['id'] == $id ? 'text-orange-400 category-checked' : '' ?>" data-id="<?php echo $category['id'] ?>">
    ...
    <div class="mt-2 px-1 border-b border-gray-100">
      ...
      <ul class="px-2 py-1 text-slate-500" style="font-size: 14px;">
        ...
        <li class="leading-5 mb-2 hover:text-orange-400">
          <a class="ps-5 price-unchecked filter cursor-pointer" id="price-m-2" data-id="2" data-from="150000" data-to="300000">
            150,000đ - 300,000đ
          </a>
        </li>
        <li class="leading-5 mb-2 hover:text-orange-400">
