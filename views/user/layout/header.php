...
<head>
  ...
  <link rel="icon" type="jpg" href="./Public//images//icon.jpg">
    ...
    <div class="w-full pt-2 bg-white header-content">
      <div class="container-fuild mx-auto flex justify-start items-center">
        <div class="header-logo">
          <a href="<?php echo BASE_URL . '/' ?>"><img src="./Public/images/logo.jpg" alt="" height="75" width="180"></a>
        </div>
        <div class="flex-1 <?php if(isset($nosearch)){echo 'pointer-events-none';}; ?>">
          <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" class="w-full" method="get"> 
            <div class="w-full flex header-search relative">
              <input type="text" name="search" id="search" class="w-full header-input-search py-3 px-3" placeholder="search in wildhorizon shop">
        ...
        <div class="ms-6" style="height: 45px;">
          <a href="#"><img src="./Public/images/banners/O1CN01yOpioK1Qz7NKPWfkw_!!6000000002046-2-tps-376-90.avif" alt="" width="188" height="45"></a>
        </div>
      </div>
    </div>